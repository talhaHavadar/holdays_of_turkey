...
The orjinal source developed by Suhail Alkowaileet
the source url https://github.com/xsoh/Hijri.js/blob/master/Hijri.js
'''
...
class Umalqurra:
    ...
    def gregorean_to_hijri(self, year, month, day):
